...
const RMS_GATE_MULT = 2.25;
const RMS_CEILING_MULT = 1.45;
const RMS_GATE_MARGIN = 0.0008;
const RMS_GATE_FLOOR = 0.0038;
const RMS_LEARN_CEILING_MULT = 1.25;
const MIN_ATTACK_RATIO = 1.12;
const STRONG_ODF_RATIO = 1.6;

/* Pitch measurement window, relative to the onset */
const PITCH_DELAY_SEC = 0.035;
const PITCH_WINDOW_SEC = 0.3;
const PITCH_MIN_ESTIMATES = 4;
const PITCH_MAX_ESTIMATES = 10;
const MAX_PITCH_SPREAD_SEMITONES = 0.8;
const MAX_PITCH_MAD_SEMITONES = 0.2;
 ...
 */
const POST_ONSET_LIFT = 0.9;
const POST_ONSET_DECAY = 0.975;
