...
export function useDrillAudio(options: UseDrillAudioOptions = {}): DrillAudio {
  ...
  const { workletUrl = '/audio/pitch-processor.js?v=context-recovery-2026-08-06' } = options;
        ...
        if (data.type === 'note-onset' || data.type === 'note-candidate') {
          ...
          if (isCandidate) {
            ...
            if (plan) {
              ...
              if (slot !== null) occupiedExpectedSlotsRef.current.add(slot);
            }
          }
