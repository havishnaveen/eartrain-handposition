        ...
        <ScoreMeter
          ...
          message={result.spatialChord
            ? result.spatialChord.rootLatencySec === null
              ? 'The root was not found before the listening window ended.'
              : `Root found in ${result.spatialChord.rootLatencySec.toFixed(1)}s${result.spatialChord.buildLatencySec === null ? '' : ` · shape built in ${result.spatialChord.buildLatencySec.toFixed(1)}s`}.`
        ...
        <ScoreMeter
          ...
          message={result.spatialChord
            ? result.spatialChord.wrongRootGuesses + result.spatialChord.wrongShapeGuesses === 0
              ? 'No random guesses—each note had a purpose.'
              : `${result.spatialChord.wrongRootGuesses + result.spatialChord.wrongShapeGuesses} searching ${result.spatialChord.wrongRootGuesses + result.spatialChord.wrongShapeGuesses === 1 ? 'guess' : 'guesses'}.`
            : undefined}
        />
      </div>
