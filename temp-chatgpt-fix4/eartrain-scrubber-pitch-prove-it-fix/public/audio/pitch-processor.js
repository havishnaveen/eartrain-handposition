...
const RMS_GATE_MULT = 1.55;
const RMS_CEILING_MULT = 1.08;
const RMS_GATE_MARGIN = 0.00012;
const RMS_GATE_FLOOR = 0.00075;
const RMS_LEARN_CEILING_MULT = 1.1;
const MIN_ATTACK_RATIO = 1.035;
const STRONG_ODF_RATIO = 1.25;

/* Pitch measurement window, relative to the onset */
const PITCH_DELAY_SEC = 0.035;
const PITCH_WINDOW_SEC = 0.3;
const PITCH_MIN_ESTIMATES = 2;
const PITCH_MAX_ESTIMATES = 10;
const MAX_PITCH_SPREAD_SEMITONES = 1.0;
const MAX_PITCH_MAD_SEMITONES = 0.45;
const MIN_PITCH_CONSENSUS = 0.45;
const MIN_REPORTED_CLARITY = 0.22;
