          ...
          <div className="et-proof__layout">
            <div className="et-proof__identity">
              <LessonPanel
                ...
                anchorNote={proofRegisterLabel(proofNotes[0].pitch)}
            ...
            <ol
              ...
              aria-label={proofNotes
                .map((note, index) => index === 0
                  ? `Hold Finger ${note.finger} on ${proofPitchName(note.pitch)}`
                  : `keep holding and add Finger ${note.finger} on ${proofPitchName(note.pitch)}`)
              ...
              {proofNotes.map((note, index) => {
                ...
                return (
                  ...
                  >
                    <span>
                      {index === 0
                        ? `Hold Finger ${note.finger} on`
                        : `Keep holding · Add Finger ${note.finger} on`}
                    </span>
